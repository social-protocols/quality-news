...
func accumulateAttention(ndb newsDatabase, logger leveledLogger, pageType int, storyID int, oneBasedRank int, sampleTime int64, deltaUpvotes int, totalUpvotes int, totalComments int, sitewideUpvotes int, submissionTime int64) [2]float64 {
